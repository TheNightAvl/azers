...
def run_simulation(name: str, board_generator, opposition_enabled: bool, 
    ...
    for config_name, board_generator, opposition_enabled in configurations:
        if "Mode 2" in config_name:
            ...
            all_results[config_name] = run_simulation(
                config_name, mode2_positions, opposition_enabled, search_depth, num_games, display_boards)
        else:
            # Mode 1
            all_results[config_name] = run_simulation(
                config_name, board_generator, opposition_enabled, search_depth, num_games, display_boards)
